...
This project is indexed by GitNexus as **cloudflared** (9082 symbols, 26926 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/cloudflared/context` | Codebase overview, check index freshness |
| `gitnexus://repo/cloudflared/clusters` | All functional areas |
| `gitnexus://repo/cloudflared/processes` | All execution flows |
| `gitnexus://repo/cloudflared/process/{name}` | Step-by-step execution trace |
